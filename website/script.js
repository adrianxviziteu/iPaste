...
const translations = {
  ...
  ro: {
    ...
    'legal.kicker': 'Nocket · Legal',
    'legal.local': 'Local, înainte de toate',
    'legal.open': 'Open source',
    'legal.onThisPage': 'Pe această pagină',
    'legal.overview': 'Pe scurt',
    'legal.summary': 'Rezumat',
    'legal.current': 'Actualizat',
    'legal.back': '← Înapoi la Nocket',
    'legal.ctaLabel': 'Înapoi la lucrurile utile',
    'legal.ctaTitle': 'Ține la îndemână<br /><em>ce contează.</em>',
    'legal.ctaBody': 'Clipboard-ul tău, la o singură privire distanță.',
    ...
    'privacy.summaryTitle': 'Un strat privat peste munca ta.',
    'privacy.summaryBody': 'Nocket păstrează istoricul clipboard-ului aproape de muncă, pe Mac-ul pe care l-ai creat.',
    'privacy.pointOneTitle': 'Păstrat pe Mac-ul tău.',
    'privacy.pointOneBody': 'Istoricul clipboard-ului rămâne pe dispozitivul tău.',
    'privacy.pointTwoTitle': 'Fără server Nocket.',
    'privacy.pointTwoBody': 'Conținutul copiat nu este încărcat pe un server Nocket.',
    'privacy.pointThreeTitle': 'Privat implicit.',
    'privacy.pointThreeBody': 'Abordarea local-first păstrează experiența discretă și concentrată.',
    'privacy.noteTitle': 'Local, implicit.',
    'privacy.noteBody': 'Nocket este gândit să țină aproape lucrurile pe care le copiezi, fără să le trimită în altă parte.',
    ...
    'terms.summaryTitle': 'Software open source, cu o bază simplă.',
    'terms.summaryBody': 'Nocket este oferit ca software open source, sub licența MIT.',
    'terms.pointOneTitle': 'Licență MIT.',
    'terms.pointOneBody': 'Proiectul este disponibil sub licența MIT.',
    'terms.pointTwoTitle': 'Fără abonament.',
    'terms.pointTwoBody': 'Nocket este gratuit, fără cont și fără plată recurentă.',
    'terms.pointThreeTitle': 'Folosește-l cum vrei.',
    'terms.pointThreeBody': 'Citește codul, modifică-l sau pur și simplu folosește aplicația.',
    'terms.noteTitle': 'Simplu prin design.',
    'terms.noteBody': 'Nocket păstrează produsul și termenii săi direcți: open source, local și ușor de înțeles.'
  }
};
